        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @can('setores')
                        <x-nav-link :href="route('modules.setores')" :active="request()->routeIs('modules.setores')">
                            Setores Hospitalares
                        </x-nav-link>
                    @endcan

                    @can('especialidades')
                        <x-nav-link :href="route('modules.especialidades')" :active="request()->routeIs('modules.especialidades')">
                    ...
                    @can('unidades')
                        <x-nav-link :href="route('modules.unidades')" :active="request()->routeIs('modules.unidades')">
